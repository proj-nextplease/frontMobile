...
/// bản trắng cho nền tối. Màu của nó đảo theo chế độ sáng/tối — để cố định một
/// màu thì nó biến mất hẳn ở chế độ ngược lại. Lỗi này đã xảy ra hai lần trong
/// dự án, một lần ở mỗi chiều.
class SocialMark extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // GitHub là logo ĐƠN SẮC nên phải đảo theo nền: để cố định một màu thì nó
    // biến mất hẳn ở chế độ ngược lại. Google và Facebook là logo nhiều màu,
    // giữ nguyên ở cả hai chế độ theo đúng điều khoản thương hiệu.
    ...
    return SvgPicture.string(
      switch (provider) {
        ...
        SocialProvider.github => _github.replaceFirst('{ink}', ink),
      },
      width: size,
      height: size,
    );
